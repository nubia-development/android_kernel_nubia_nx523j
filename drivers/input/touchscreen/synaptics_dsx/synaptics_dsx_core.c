		...
		struct device_attribute *attr, const char *buf, size_t count)
{
	...
	rmi4_data->enable_palm_sleep = input;
...
static void report_palm_event(struct synaptics_rmi4_data *rmi4_data)
{

    if(rmi4_data->enable_palm_sleep == false) {
        dev_info(rmi4_data->pdev->dev.parent,"palm sleep is disabled.\n");
        return;
    }
...
static int synaptics_rmi4_probe(struct platform_device *pdev)
{
	...
	rmi4_data->enable_palm_sleep = false;
